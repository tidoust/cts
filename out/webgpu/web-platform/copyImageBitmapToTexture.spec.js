...
got [${failedByteActualValues.join(', ')}]`;
  ...
  generatePixel(color, format) {var _generatedPixelCache$, _generatedPixelCache$3;
    ...
    if (!((_generatedPixelCache$ = generatedPixelCache.get(format)) === null || _generatedPixelCache$ === void 0 ? void 0 : _generatedPixelCache$.has(color))) {var _generatedPixelCache$2;
      let pixels;
      switch (color) {
        case Color.Red:
      ...
      (_generatedPixelCache$2 = generatedPixelCache.get(format)) === null || _generatedPixelCache$2 === void 0 ? void 0 : _generatedPixelCache$2.set(color, pixels);
    }

    return (_generatedPixelCache$3 = generatedPixelCache.get(format)) === null || _generatedPixelCache$3 === void 0 ? void 0 : _generatedPixelCache$3.get(color);
  }}
