...
**/function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}import { assert, unreachable } from '../../../common/framework/util/util.js';import { kUncompressedTextureFormatInfo } from
...
class TexelDataRepresentationImpl {
  ...
  componentInfo,
  sRGB)
  {this.format = format;this.componentOrder = componentOrder;this.componentInfo = componentInfo;this.sRGB = sRGB;_defineProperty(this, "isGPULittleEndian", true);}
