...
**/function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}import { assert } from '../util/util.js';
...
export class TestQueryMultiFile {
  ...
  constructor(suite, file) {_defineProperty(this, "level", 1);_defineProperty(this, "isMultiFile", true);_defineProperty(this, "suite", void 0);_defineProperty(this, "filePathParts", void 0);
    this.suite = suite;
...
export class TestQueryMultiTest extends TestQueryMultiFile {
  ...
  constructor(suite, file, test) {
    super(suite, file);_defineProperty(this, "level", 2);_defineProperty(this, "isMultiFile", false);_defineProperty(this, "isMultiTest", true);_defineProperty(this, "testPathParts", void 0);
...
export class TestQueryMultiCase extends TestQueryMultiTest {
  ...
  constructor(suite, file, test, params) {
    super(suite, file, test);_defineProperty(this, "level", 3);_defineProperty(this, "isMultiTest", false);_defineProperty(this, "isMultiCase", true);_defineProperty(this, "params", void 0);
...
/**
      ...
      * Immutable (makes copies of constructor args).
      */
export class TestQuerySingleCase extends TestQueryMultiCase {constructor(...args) {super(...args);_defineProperty(this, "level",
    4);_defineProperty(this, "isMultiCase",
    false);}
