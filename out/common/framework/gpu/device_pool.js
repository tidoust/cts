...
**/function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}import { assert, raceWithRejectOnTimeout, unreachable, assertReject } from '../util/util.js';import { getGPU } from './implementation.js';
...
export class DevicePool {constructor() {_defineProperty(this, "failed",
    false);_defineProperty(this, "holder",
    undefined);} // undefined if "uninitialized" (not yet initialized, or lost)
